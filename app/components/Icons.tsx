// Minimal SVG icon set — consistent 24x24 viewBox, stroke-based, currentColor
...
export function IconMap({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function IconBrain({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9.5 2a2.5 2.5 0 0 1 5 0v.5a2.5 2.5 0 0 1 2.5 2.5A2.5 2.5 0 0 1 19.5 7.5v1A2.5 2.5 0 0 1 22 11v2a2.5 2.5 0 0 1-2.5 2.5A2.5 2.5 0 0 1 17 18a2.5 2.5 0 0 1-5 0 2.5 2.5 0 0 1-2.5-2.5A2.5 2.5 0 0 1 7 13v-2A2.5 2.5 0 0 1 4.5 8.5 2.5 2.5 0 0 1 7 5.5V5a2.5 2.5 0 0 1 2.5-2.5z"/>
    </svg>
  )
}
...
export function IconCoin({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="10"/><path d="M12 6v2m0 8v2M9.5 9.5a2.5 2.5 0 0 1 5 0c0 1.5-2.5 2-2.5 4m0 1h.01"/>
    </svg>
  )
}
